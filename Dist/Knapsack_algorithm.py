# define the distribution of the jenkins according to the execution time
# input : a database consist of execution time and tests names
import numpy as np
import pandas as pd
...
def knapsack(input_Knap, W):
    ...
    # input_Knap : a database contain of execution time and tests name
    # W: initialization for capacity of each node
